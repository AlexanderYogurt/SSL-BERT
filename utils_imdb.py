...
class ImdbProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        folder3 = os.path.join(data_dir, "train", "unsup")
        return self._create_examples_from_folder([folder1, folder2, folder3], "train")
            ...
            for input_file in os.listdir(folder):
                if input_file.endswith(".txt"):
                    with open(os.path.join(folder, input_file), "r") as f:
                        ...
                        i+=1
                        text_b = None
                        label = task_labels[label_dir] # pos:1 neg:0 unsup:-1
